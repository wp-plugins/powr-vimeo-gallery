...
Sync any Vimeo user or channel to a custom gallery!

== Description ==
 Sync any Vimeo user or channel to a custom gallery!
<br>
<br>
POWr Vimeo Gallery is a free cloud-based plugin you can edit in your live web page.  Create a POWr account to access the entire <a href='https://www.powr.io/plugins'>plugin library</a>.
<br>
<br>
First, download, install, and activate POWr Vimeo Gallery. Then drop the widget anywhere in your theme. Or add to a page/post with the POWr icon in the WP editor.
<br>
= <a href='http://www.powr.io/tutorials/how-to-add-vimeo-gallery-plugin-to-your-wordpress-site'>2 MINUTE INSTALL</a> =
<br>
= Free Features =
* Automatically sync videos from any Vimeo user or channel.
* Adjust priority to display your favorite content.
...
== Installation ==
Download, install, and activate POWr Vimeo Gallery.
<br>
<br>
...
= How do I add Vimeo Gallery to a page or blog post? = Add the shortcode **[powr-vimeo-gallery label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Vimeo Gallery? = Yes, absolutely!  To clone your Vimeo Gallery, just add the exact same shortcode to pages or posts.  To create a new version of Vimeo Gallery, add a different shortcode to each page or post, for example: **[powr-vimeo-gallery label='first form']**, and **[powr-vimeo-gallery label='second form']**.

= Will my users see the settings icon in the corner of the Vimeo Gallery? = No! You only see the settings icon because you own the plugins. To temporarily hide it, click on your page and then type 'p + down arrow' (the letter p followed by the down arrow). You can show the icon again by typing 'p + up-arrow'.
...
= Is POWr Vimeo Gallery Free? = Yes, the basic version of Vimeo Gallery is completely free!
