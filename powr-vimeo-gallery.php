<?php
    /**
     * @package POWr Vimeo Gallery
     * @version 1.4
     */
    /*
    Plugin Name: POWr Vimeo Gallery
    Plugin URI: http://www.powr.io
    Description: Sync any Vimeo user or channel to a custom gallery!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Vimeo Gallery widget/////////////////////////////////
    class Powr_Vimeo_Gallery extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_vimeo_gallery',
                             __( 'POWr Vimeo Gallery' ),
                             array( 'description' => __( 'Vimeo Gallery by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-vimeo-gallery' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Vimeo Gallery.
        </p>
        <p>
    ...
    function register_powr_vimeo_gallery() {
      register_widget( 'Powr_Vimeo_Gallery' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_vimeo_gallery' );
    //Create short codes for adding plugins anywhere:
    function powr_vimeo_gallery_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-vimeo-gallery' label='$label'></div>";
    }
    add_shortcode( 'powr-vimeo-gallery', 'powr_vimeo_gallery_shortcode' );
